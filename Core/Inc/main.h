...
#define WIFI_SPI_CS_Pin GPIO_PIN_9
#define WIFI_SPI_CS_GPIO_Port GPIOA
#define WIFI_BOOT_Pin GPIO_PIN_10
#define WIFI_BOOT_GPIO_Port GPIOA
#define WIFI_CHIP_EN_Pin GPIO_PIN_11
#define WIFI_CHIP_EN_GPIO_Port GPIOA
#define WIFI_SPI_RDY_Pin GPIO_PIN_12
#define WIFI_SPI_RDY_GPIO_Port GPIOA
